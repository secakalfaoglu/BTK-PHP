...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($baslikErr) && empty($altBaslikErr) && empty($resimErr)) {
        ...
        if (editCourse($id, $baslik, $altBaslik, $aciklama, $resim, $onay,$anasayfa)) {
            ...
            $_SESSION['message'] = $baslik . " kursu başarıyla güncellendi.";
            ...
            <div class="row">
                <div class="col-9">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="altBaslik" class="form-control" value="<?php echo $selectedCourse["baslik"]; ?>">
                        <div class="text-danger"><?php echo $altBaslikErr; ?></div>
                    </div>
                    <div class="mb-3">
                        <label for="aciklama">Açıklama</label>
                        <textarea name="aciklama" class="form-control" id="aciklama"><?php echo $selectedCourse["aciklama"]; ?></textarea>
                ...
                <div class="col-3">
                    <img src="img/<?php echo $selectedCourse["resim"]; ?>" alt="" class="img-fluid" style="border-radius: 10px;">
                    <hr>
