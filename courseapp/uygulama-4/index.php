        ...
        <div class="row">
            <div class="col-3">
                <div class="list-group">
                    <a href="" class="list-group-item list-group-action active"><?php echo $kategoriler[0]; ?></a>
                    <a href="" class="list-group-item list-group-action"><?php echo $kategoriler[1]; ?></a>
                    <a href="" class="list-group-item list-group-action"><?php echo $kategoriler[2]; ?></a>
                    <a href="" class="list-group-item list-group-action"><?php echo $kategoriler[3]; ?></a>
